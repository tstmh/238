 ...
 * <p>Description : WCSS Message Receiver</p>
 * <p>This class is used by CMH to receive object from WCSS_CMH_Q queue
...
public class WCSSMessageReceiver implements MessageListener {
	
private static Logger logger = LoggerFactory.getLogger(WCSSMessageReceiver.class);
	...
	public void onMessage(Message pMessage) {
		if (logger.isInfoEnabled()) {
			logger.info("WCSSJmsListener started receiving the message.....");
		}
		try {
