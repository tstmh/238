 ...
 * <p>Description : IDSS Message Receiver</p>
 * <p>This class is used by CMH to receive object from IDSS_CMH_Q queue 
 * <p>Company:ST Engineering Electronics</p>
 * @author Scindia
 * @since Apr 06, 2021
...
public class IDSSMessageReceiver implements MessageListener {
	
private static Logger logger = LoggerFactory.getLogger(IDSSMessageReceiver.class);
	...
	public void onMessage(Message pMessage) {
		if (logger.isInfoEnabled()) {
			logger.info("IDSSJmsListener started receiving the message.....");
		}
		try {
