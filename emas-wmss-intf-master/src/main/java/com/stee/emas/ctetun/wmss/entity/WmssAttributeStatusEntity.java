...
@IdClass(com.stee.emas.ctetun.wmss.entity.WmssAttributeStatusIdClass.class)
public class WmssAttributeStatusEntity implements Serializable {
	...
	public String toString() {
		return "WmcsAttributeStatusEntity [equipId=" + equipId + ", attributeCode=" + attributeCode
