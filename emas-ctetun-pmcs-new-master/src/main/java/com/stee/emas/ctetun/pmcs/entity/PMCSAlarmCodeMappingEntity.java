...
public class PMCSAlarmCodeMappingEntity implements Serializable {
	...
	public String toString() {
		return "PmcsAlarmCodeMappingEntity [equipType=" + equipType + ", attributeCode=" + attributeCode + ", felsCode="
